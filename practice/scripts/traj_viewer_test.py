...
DATA_FILE = envutils.test_file(os.path.join('trajs', 'c6.data'))
DUMP_FILE = envutils.test_file(os.path.join('trajs', 'c6.custom'))
XYZ_FILE = envutils.test_file(os.path.join('trajs', 'c6.xyz'))
